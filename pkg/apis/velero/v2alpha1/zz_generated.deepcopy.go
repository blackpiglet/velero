...
func (in *CBTStatus) DeepCopyInto(out *CBTStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CBTStatus.
func (in *CBTStatus) DeepCopy() *CBTStatus {
	if in == nil {
		return nil
	}
	out := new(CBTStatus)
