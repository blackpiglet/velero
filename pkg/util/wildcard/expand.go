...
func ShouldExpandWildcards(includes []string, excludes []string, fromBackup bool) bool {
	...
	// We don't want to allow wildcard patterns in restore request,
	// because restore needs the IncludeEverything function to determine whether to restore cluster-scoped resources.
