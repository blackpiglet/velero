...
func RunKibishiiTests(
	...
	if useVolumeSnapshots {
		...
		pvbNum, err := PVBNumWithPodInSpecificNS(timeOutContext, veleroCfg.VeleroNamespace, kibishiiNamespace)
		if err != nil {
	...
	if !useVolumeSnapshots && providerName != Vsphere {
		pvrNum, err := PVRNumWithPodInSpecificNS(timeOutContext, veleroCfg.VeleroNamespace, kibishiiNamespace)
		if err != nil {
